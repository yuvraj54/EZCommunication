...
public class News extends AppCompatActivity {
    ...
    private static final String NEWS_URL = "http://ezcommunication.somee.com/webservice.asmx/News";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String studentcollage = (sharedpreferences.getString("studentcollage", ""));
        //Toast.makeText(News.this, studentcollage, Toast.LENGTH_LONG).show();


        requestQueue = Volley.newRequestQueue(getApplicationContext());
        recyclerView = (RecyclerView)findViewById(R.id.relativeLayout2);
...
//                                recyclerView.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
                    ...
                    protected Map<String, String> getParams() throws AuthFailureError {
                        ...
                        map.put("collage", studentcollage);
                        return map;
                    }
